...
let sendMessage = '<h1 style="text-align:center;color:red;position:absolute;top:0%;left:40%;font-size:50px;">404 Content not found!!<h1>';

exports.search = (req,res)=>{
    const item = req.body.item;

    product.findOne({name:item},(err,found)=>{
        if(err) throw err;
        if(found){
